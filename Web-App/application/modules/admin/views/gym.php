                ...
                <div class="we-page-title">
                    <div class="row">
                        <div class="col-md-5 align-self-center">
                            <h3 class="we-page-heading">Gym</h3> </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="postal_code" class="form-control postal_code" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                        ...
                                                        <div class="sb-feeds-footer">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 text-left">
                                                                    <a class="Visit-btn" href="'.$website_url.'" target="_blank" title="">
                                                                        Visit Site
                                                                    </a>
                                                                </div>
