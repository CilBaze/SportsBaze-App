    ...
    <div class="we-page-title">
        <div class="row">
            <div class="col-md-5 align-self-center">
                <h3 class="we-page-heading">Sports Centre</h3> </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Sports Centre</li>
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="upload-video-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Rating</label>
                                        <input type="text" name="rating" class="form-control rating"  placeholder="Rating">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Url</label>
                                        <input type="text" name="website_url" class="form-control"  placeholder="www.test.com">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                ...
                <div class="feeds-sidebar">
                    <div class="feeds-search">
                        <div class="sidebar-form-group">
                            <form method="get" action="<?php echo base_url('admin/sports_center');?>">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input class="form-control" type="text" name="keywords" value="<?php  echo @$this->input->get('keywords');?>" placeholder="Search by Title ,Type, Description">
                                            ...
                                            <div class="sb-feeds-footer">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 text-left">
                                                        ...
                                                        <!--<a class="Visit-btn" href="'.base_url('admin/book_appointment/'.encrypt_decrypt('encrypt',$posts->post_id)).'" target="_blank" title="">
                                                            Book Appointment
                                                        </a>-->
                                                    </div>
