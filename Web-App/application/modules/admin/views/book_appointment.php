    ...
    <div class="we-page-title">
        <div class="row">
            <div class="col-md-5 align-self-center">
                <h3 class="we-page-heading">Sports Centre Enquiry</h3> </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Sports Centre Enquiry</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="user-data-section">
        <div class="user-list-item">
            <div class="user-table-filter">
                <form method="get" action="<?php echo base_url('admin/book_appointment');?>">
                     <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <select name="post_type" class="form-control">
                                    <option>All</option>
                                    <option value="gym" <?php echo (isset($filter_data['keywords']) && ($filter_data['post_type']=='gym'))?'selected':'';?>>Gym</option>
                                    <option value="coaching_academy" <?php echo (isset($filter_data['keywords']) && ($filter_data['post_type']=='coaching_academy'))?'selected':'';?>>Coaching Academy</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
                              ...
                              if(count($result) > 0) {
                                 ...
                                 ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-text-info">
                                                <div class="table-info-value"><?php echo ($user_info->post_type=='coaching_academy')?'Coaching Academy':'Gym';?></div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="table-text-info">
                                        ...
                                        <td>
                                            <div class="table-text-info">
                                                <div class="table-info-value"><?php echo $user_info->phone_number;?></div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="table-text-info">
                                        ...
                                        <td>
                                            <div class="table-text-info">
                                                <?php echo date('d, F Y', strtotime($user_info->date));?>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="table-text-info">
                                                <?php echo date('h:i A', strtotime($user_info->time));?>
                                            </div>
                                        </td>
                                    </tr>
                           <?php }
