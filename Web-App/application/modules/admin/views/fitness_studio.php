                ...
                <div class="we-page-title">
                    <div class="row">
                        <div class="col-md-5 align-self-center">
                            <h3 class="we-page-heading">Fitness Studio</h3> </div>
                        <div class="col-md-7 align-self-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Fitness Studio</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="upload-video-form">
                                <form action="<?php echo base_url('admin/save_upload_video/fitness_studio');?>" method="post" enctype="multipart/form-data" id="postForm">
                            ...
                            <div class="feeds-sidebar">
                                <div class="feeds-search">
                                    <div class="sidebar-form-group">
                                        <form method="get" action="<?php echo base_url('admin/fitness_studio');?>">
                                                        ...
                                                        <div class="feeds-footer">
                                                            <div class="feeds-option-info">
                                                                <div class="feeds-like">
                                                                    <a href="javascript:void(0);" class="view-all-likes" data-id="'.encrypt_decrypt('encrypt', $posts->post_id).'">
                                                                ...
                                                                <!--<div class="feeds-like">
                                                                    <a href="#">
                                                                        ...
                                                                        '.$posts->total_favourite.' Favourites
                                                                    </a>
                                                                </div>-->
                                                            </div>
                                                        </div>
