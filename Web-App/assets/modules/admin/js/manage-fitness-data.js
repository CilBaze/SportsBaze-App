...
$(document).on('click', '.category_action', function () {
    ...
    if(action == "delete") {
        ...
        $.ajax({
            type: 'get',
            url: base_url+'admin/get_category_modal/fitness_studio?sports_id='+id,
...
$(document).on('submit',"#categoryForm",function(e) {
    ...
    $.ajax({
        url: base_url + "admin/add_category/fitness_studio",
        data: formdata,
        type: 'POST',
        dataType: 'json',
        beforeSend: function() {
...
$(document).on('click', '.sub_category_action', function () {
    ...
    if(action == "delete") {
        ...
        $.ajax({
            type: 'get',
            url: base_url+'admin/get_subcategory_modal/fitness_studio?sub_sports_id='+id,
            success: function (data) {
...
$(document).on('submit',"#subCategoryForm",function(e) {
    ...
    $.ajax({
        url: base_url + "admin/add_subcategory/fitness_studio",
        data: formdata,
        type: 'POST',
        dataType: 'json',
        beforeSend: function() {
