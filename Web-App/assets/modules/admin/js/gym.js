...
$(document).on('submit',"#postForm",function(e) {
    ...
    var formdata = { post_id: $(this).find('input[name=post_id]').val(), latitude: $(this).find('input[name=latitude]').val(),
     longitude: $(this).find('input[name=longitude]').val(), title: $(this).find('input[name=title]').val(), location: $(this).find('input[name=location]').val(), description: $(this).find('textarea[name=description]').val(), website_url: $(this).find('input[name=website_url]').val(), postal_code: $(this).find('input[name=postal_code]').val()};
    
    $.ajax({
        url: base_url + "admin/save_upload_video/gym",
        data: formdata,
        type: 'POST',
        dataType: 'json',
        beforeSend: function() {
