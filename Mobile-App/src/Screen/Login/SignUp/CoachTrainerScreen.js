...
let SportList_Data = []
class CoachTrainerScreen extends React.Component {
    constructor() {
        super();
        this.state = {
            value: false,
    ...
    NextScreen = async () => {
        ...
        try {
            console.log('Coachtrainer_image::::::', this.state.filePath)
        ...
        this.props.navigation.navigate('NextCoachTrainerScreen', {
    ...
    render() {
        ...
        console.log('SportList_Data::::::', SportList_Data);
        return (
...
export default CoachTrainerScreen