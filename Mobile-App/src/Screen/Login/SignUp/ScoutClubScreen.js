...
class ScoutClubScreen extends React.Component {
    constructor() {
        super();
        this.state = {
            value: false,
    ...
    NextScreen = async () => {
        ...
        try {
            console.log('ScoutClub_image::::::', this.state.filePath)
        ...
        this.props.navigation.navigate('NextScoutClubScreen', {
...
export default ScoutClubScreen