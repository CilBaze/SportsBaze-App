...
import { View, Text, TouchableOpacity, Image, TextInput, Keyboard, PermissionsAndroid, Alert,Platform } from 'react-native'
...
let SportList_Data = []
class AthleteScreen extends React.Component {
    constructor() {
        super();
        this.state = {
            value: false,
    ...
    NextScreen = async () => {
        ...
        this.props.navigation.navigate('NextAthlteScreen', {
                ...
                <View style={{ flex: 1, }}>
                    <View style={{ flex: 1, alignItems: 'center', flexDirection: 'column' }}>
                        <View style={{ flexDirection: 'row',}}>
                            <TouchableOpacity style={{ marginRight: "28%", marginTop: "11%", }} onPress={this.GoBack}>
                                <Image style={{ width: 20, height: 20 }} source={require('../../../Images/back.png')} />
                            </TouchableOpacity>
                            <Text style={styles.headerText3}>Athlete</Text>
                        </View>
                        <TouchableOpacity style={{marginTop: '8%'}} onPress={this.chooseFile}>
                            {this.state.filePath != '' ? <Image
                                source={{ uri: this.state.filePath }} style={styles.img}
                            /> :
                                <Image style={styles.img} source={require('../../../Images/ic_profile.png')} />
                            }
