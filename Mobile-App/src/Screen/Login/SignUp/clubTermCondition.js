...
let scouting_sports_id = ''
let ischeckedFreelance = ''
let profession = ''

export default class clubTermCondition extends React.Component {
    ...
    SubmitData = async () => {
        ...
        formData.append('scouting_sports', scouting_sports_id)
        formData.append('is_freelance', ischeckedFreelance)
    ...
    render() {
        ...
        scouting_sports_id = this.props.route.params.scouting_sports_id
        ischeckedFreelance = this.props.route.params.ischeckedFreelance
        profession = this.props.route.params.profession

        console.log("selectLetterFileResponse::", selectLetterFileResponse)
        console.log("selectIdCardResponse::", selectIdCardResponse)
        console.log(" selectFileResponse::", selectFileResponse)
