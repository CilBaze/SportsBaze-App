...
let parent_email = ''
let parent_no = ''
class NextCoachTrainerScreen extends React.Component {
    constructor() {
        super();
        this.state = {
            value: false,
    ...
    GoToNextScreen = () => {
        ...
        this.props.navigation.navigate('ProfessionalVerifactiuonCTScreen', {
                ...
                <View style={{ flex: 1, }}>
                    <View style={{ flex: 1, alignItems: 'center', flexDirection: 'column' }}>
                        ...
                        <TouchableOpacity style={styles.imgBg}>
                            {this.state.image_filePath != '' ? <Image
...
export default NextCoachTrainerScreen